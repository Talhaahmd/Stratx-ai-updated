          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-1">
                <div className={`tp-footer-2-widget-logo ${whiteFooter ? "tp-footer-dark" : ""}`}>
                ...
                <div className="tp-footer-2-widget-text">
                  <p>
                    Drop us a line and we'll contact you very shortly.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link
                      ...
                      target="_blank"
                    >
                      Toronto, GTA. <br /> Lahore, Pakistan
                    </Link>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link href="tel:+725214456">+1 (437) 879-4050</Link>
                  </span>
                </div>
                <div className="tp-footer-2-contact-item">
                  <span>
                    <Link href="mailto:contact@liko.com">Info@stratx.io</Link>
                  </span>
                </div>
              </div>
            </div>
